...
var _ fs.Node = (*rootsDir)(nil)
var _ fs.HandleReadDirAller = (*rootsDir)(nil)
var _ fs.NodeRemover = (*rootsDir)(nil)
var _ fs.NodeRenamer = (*rootsDir)(nil)
var _ fs.NodeStringLookuper = (*rootsDir)(nil)
var _ fs.NodeMkdirer = (*rootsDir)(nil)
...
func (n *rootsDir) condRefresh() error {
	...
	if err := grp.Err(); err != nil {
		log.Printf("fs.roots: condRefresh error: %v", err)
		return fuse.EIO
	}
